...
//   He, Luheng et al. “Deep Semantic Role Labeling: What Works and What's Next.” ACL (2017).
{
  ...
  "train_data_path": '/home/zijiao/work/multimodel_seq2seq/output/train_srls.json',
  "validation_data_path": '/home/zijiao/work/multimodel_seq2seq/output/val4000_srls.json',
  "model": {
    "type": "srl",
    "text_field_embedder": {
      "token_embedders": {
